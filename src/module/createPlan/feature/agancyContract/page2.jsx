  ...
  return (
    <div className="contract-page page-1">
      <div className="text-justify leading-relaxed text-sm">
        ...
        <p className="mb-3 pr-4">
          <span className="font-bold">7) روز کاري: </span>
          تمام روزهاي هفته‌ به‌ غیر از پنج‌شنبه‌، جمعه‌، تعطیلات رسمی‌ و روزهایی‌ که‌ به‌ هر دلیلی‌
          بانک‌ها تعطیل‌ می‌باشند، روز کاري محسوب می‌گردد.
        </p>
        <p className="mb-3 pr-4">
          <span className="font-bold">8) قرارداد اقدامات اجرایی‌: </span>
          قراردادي که‌ در صورت موفقیت‌ کمپین‌، به‌ طرح موضوع قرارداد، مواعد و مبالغ‌ چک‌هاي اقساط و
          چک‌هاي تضمین‌ و ... می‌پردازد.
        </p>

        <p className="mb-3 pr-4">
          <span className="font-bold">9) تأمین‌ مالی‌ شناور: </span>
        ...
        <p className="mb-3 pr-4">
          <span className="font-bold">3) </span>
           ارائه‌ خدمات عاملیت‌ و انجام مراحل‌ قانونی‌ اخذ مجوزهاي لازم از شرکت‌ فرابورس ایران
          جهت‌ انتشار گواهی‌هاي شراکت‌ تأمین‌ مالی‌ جمعی‌ مطابق‌ با شرایط‌ مندرج در جدول مادة ٥ این‌
          قرارداد. به میزان {(agencyContract?.investor_request?.amount_of_investment || 0 / 1000).toLocaleString()}
          گواهی شراکت.
        </p>
      </div>
    </div>
