...
const Descript = () => {
  ...
  const fields = [
    ...
    { label: "حداقل مبلغ مورد نیاز جهت موفقیت تامین مالی (ریال)", value: `${formatNumber(data.minimum_required_price)} ریال` },
    { label: "حداقل مبلغ سرمایه‌گذاری برای تامین کننده حقیقی (ریال)", value: `${formatNumber(data.real_person_minimum_availabe_price)} ریال` },
    { label: "حداکثر مبلغ سرمایه‌گذاری برای تامین کننده حقیقی (ریال)", value: `${formatNumber(data.real_person_maximum_available_price)} ریال` },
    { label: "حداقل مبلغ سرمایه‌گذاری برای تامین کننده حقوقی (ریال)", value: `${formatNumber(data.legal_person_minimum_availabe_price) || 0} ریال` },
    { label: "حداکثر مبلغ سرمایه‌گذاری برای تامین کننده حقوقی (ریال)", value: `${formatNumber(data.legal_person_maximum_availabe_price) || 'نامشخص'}` },
